...
<script type="text/javascript">
    ...
    function loadDepartment(oper, enterGoodsTypeId) {
        ...
        $.ajax({
            type : "get",
            url : "${pageContext.request.contextPath}/admin/Advertisment/page.do",
            dataType : "json",
            async : true,
    ...
    $(function($) {
        ...
        $("#grid-table").jqGrid({
            ...
            colNames:["编辑/删除","","广告标题","广告内容","广告图片","上架状态","添加时间","发布时间"], //,"点赞数","分享数","添加时间","修改时间","删除时间","是否开放","备注","删除标识"
            colModel:[
                {name: 'myac', index: '', width: 80, fixed: true, sortable: false, resize: false,search:false,
                    ...
                    formatoptions: {
                        ...
                        delOptions: { recreateForm: true,
                            ...
                            url : "${pageContext.request.contextPath}/admin/Advertisment/deleteAjax.do",/* 删除Product的URL */
                        },
                        editbutton:true,
                        editformbutton: true,
                        editOptions:{  closeOnEscape: true,
                            ...
                            reloadAfterSubmit : false,
                            url : "${pageContext.request.contextPath}/admin/Advertisment/updateAjax.do",/* 修改Product的URL */
                        }
                    }
                },
                ...
                {name:"adsTt",index:"adsTt",hidden : false, editable: true, width:90, align:"center"},
                {name:"adsContent",index:"adsContent",hidden : true, editable: true, width:90, align:"center"},
                {name:"adsPic",index:"adsPic",hidden : false, editable: true, width:90, align:"center"},
                {name:"adsState",index:"adsState",  editable: true,width:80, align:"center"},
                {name:"addTime",index:"addTime",  editable: true,width:80, align:"center"},
                {name:"adsOnme",index:"adsOnme",  editable: true,width:80, align:"center"},
...
// 		var id=rowData.enteringGoodsId;
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType : 'text',
                url: "${pageContext.request.contextPath}/admin/Advertisment/saveAjax.do",
                //序列化form表单
