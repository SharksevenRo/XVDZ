...
<script type="text/javascript">
    ...
    function loadDepartment(oper, enterGoodsTypeId) {
        ...
        $.ajax({
            type : "get",
            url : "${pageContext.request.contextPath}/admin/ReceiveAddress/page.do",
            dataType : "json",
            async : true,
                ...
                {name: 'myac', index: '', width: 80, fixed: true, sortable: false, resize: false,search:false,
                    ...
                    formatoptions: {
                        ...
                        delOptions: { recreateForm: true,
                            ...
                            url : "${pageContext.request.contextPath}/admin/ReceiveAddress/deleteAjax.do",/* 删除Product的URL */
                        },
                        editbutton:true,
                        editformbutton: true,
                        editOptions:{  closeOnEscape: true,
                            ...
                            reloadAfterSubmit : false,
                            url : "${pageContext.request.contextPath}/admin/ReceiveAddress/updateAjax.do",/* 修改Product的URL */
                        }
                    }
                },
...
// 		var id=rowData.enteringGoodsId;
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType : 'text',
                url: "${pageContext.request.contextPath}/admin/ReceiveAddress/saveAjax.do",
                //序列化form表单
