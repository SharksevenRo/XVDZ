                ...
                <form id="enteringGoodsForm" class="form-horizontal" method="post">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input class="form-control" placeholder="请输入订单名称"  type="text" name="pdtName">
                            </div>
                            <label class="col-md-2 control-label">订单介绍：</label>
                            <div class="col-md-4">
                                <input class="form-control" placeholder="请输入订单名称"  type="text" name="pdtPc">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">订单标签：</label>
                            <div class="col-md-4">
...
<script type="text/javascript">
    ...
    function loadOrder(oper, enterGoodsTypeId) {
        $("select[name=enterGoodsTypeId]").html("");
        $.ajax({
            type : "get",
            url : "${pageContext.request.contextPath}/admin/Orders/page.do",
            dataType : "json",
            async : true,
    ...
    $(function($) {
        ...
        $("#grid-table").jqGrid({
            ...
            colNames:["编辑/删除","","订单编号","订单总价","订单折扣","实际付款","订单状态","下单时间"], //,"点赞数","分享数","添加时间","修改时间","删除时间","是否开放","备注","删除标识"
            colModel:[
                {name: 'myac', index: '', width: 80, fixed: true, sortable: false, resize: false,search:false,
                    ...
                    formatoptions: {
                        ...
                        delOptions: { recreateForm: true,
                            ...
                            url : "${pageContext.request.contextPath}/admin/Orders/deleteAjax.do",/* 删除Product的URL */
                        },
                        editbutton:true,
                        editformbutton: true,
                        editOptions:{  closeOnEscape: true,
                            ...
                            reloadAfterSubmit : false,
                            url : "${pageContext.request.contextPath}/admin/Orders/updateAjax.do",/* 修改Product的URL */
                        }
                    }
                },
                ...
                {name:"orNo",index:"orNo",hidden : false, editable: true, width:90, align:"center"},
                {name:"orTotal",index:"orTotal", editable: true, width:90, align:"center"},
                {name:"orDiscount",index:"orDiscount",hidden : false, editable: true, width:90, align:"center"},
                {name:"orRealCost",index:"orRealCost",  editable: true,width:80, align:"center"},
                {name:"orState",index:"orState",  editable: true,width:80, align:"center"},
...
// 		var id=rowData.enteringGoodsId;
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType : 'text',
                url: "${pageContext.request.contextPath}/admin/Orders/saveAjax.do",
                //序列化form表单
