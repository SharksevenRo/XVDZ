...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $("#grid-table").jqGrid({
            //提交类型
            type:"post",
            url: "${pageContext.request.contextPath}/admin/DiscountCode/page.do",
            //数据类型
            datatype: "json",
            jsonReader: {
            ...
            colNames:["编辑/删除","","优惠码编号","优惠码出码时间","优惠码有效时间","使用次数","优惠码说明"], //,"点赞数","分享数","添加时间","修改时间","删除时间","是否开放","备注","删除标识"
            colModel:[
                {name: 'myac', index: '', width: 80, fixed: true, sortable: false, resize: false,search:false,
                    ...
                    formatoptions: {
                        ...
                        delOptions: { recreateForm: true,
                            ...
                            url : "${pageContext.request.contextPath}/admin/DiscountCode/deleteAjax.do",/* 删除Product的URL */
                        },
                        editbutton:true,
                        editformbutton: true,
                        editOptions:{  closeOnEscape: true,
                            ...
                            reloadAfterSubmit : false,
                            url : "${pageContext.request.contextPath}/admin/DiscountCode/updateAjax.do",/* 修改Product的URL */
                        }
                    }
                },
                ...
                {name:"disCodeNo",index:"disCodeNo",hidden : false, editable: true, width:90, align:"center"},
                {name:"disCodeTime",index:"disCodeTime",hidden : true, editable: true, width:90, align:"center"},
                {name:"disCodeValidTime",index:"disCodeValidTime", editable: true, width:90, align:"center"},
                {name:"disCodeNum",index:"disCodeNum",hidden : false, editable: true, width:90, align:"center"},
                {name:"disCodeRemark",index:"disCodeRemark",  editable: true,width:80, align:"center"},
...
// 		var id=rowData.enteringGoodsId;
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType : 'text',
                url: "${pageContext.request.contextPath}/admin/DiscountCode/saveAjax.do",
                //序列化form表单
