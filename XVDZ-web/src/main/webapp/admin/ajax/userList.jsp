...
<!--                    		<div class="form-group"> -->
                            ...
                            <div class="col-md-4"> 
                                <input class="form-control" placeholder="请输入用户名称"  type="text" name="pdtName">
                            </div>
                             <label class="col-md-2 control-label">用户介绍：</label>
                            <div class="col-md-4"> 
                                <input class="form-control" placeholder="请输入用户名称"  type="text" name="pdtPc">
                            </div>
                        </div>
                        <div class="form-group">
                         	<label class="col-md-2 control-label">用户标签：</label>
                            <div class="col-md-4">
...
<script type="text/javascript">
	...
	$("#grid-table").jqGrid({ 
		//提交类型
		type:"post",
        url: "${pageContext.request.contextPath}/admin/user/page.do",
        //数据类型
        datatype: "json", 
         jsonReader: {  
		...
		colNames:["编辑/删除","","用户姓名","用户类型","用户昵称","用户性别","用户手机","用户邮箱","注册时间"], //,"点赞数","分享数","添加时间","修改时间","删除时间","是否开放","备注","删除标识"
		colModel:[ 
				   {name: 'myac', index: '', width: 80, fixed: true, sortable: false, resize: false,search:false,
					...
					　　　　formatoptions: {
						...
						　　　 delbutton:true,　　
						     ...
						     delOptions: { recreateForm: true, 
											...
											url : "${pageContext.request.contextPath}/admin/user/deleteAjax.do",/* 删除Product的URL */ 
										},
							 editbutton:true, 
							 ...
							 editOptions:{  closeOnEscape: true,
											...
											reloadAfterSubmit : false,
											url : "${pageContext.request.contextPath}/admin/user/updateAjax.do",/* 修改Product的URL */ 
							 }
						} 
					}, 
					...
					{name:"usName",index:"usName",hidden : false, editable: true, width:90, align:"center"},
					 {name:"typeId",index:"typeId", editable: true, width:90, align:"center"},
				   {name:"usNcNa",index:"usNcNa",hidden : true, editable: true, width:90, align:"center"},
				   {name:"usSex",index:"usSex",hidden : false, editable: true, width:90, align:"center"}, 
				   {name:"usTel",index:"usTel",  editable: true,width:80, align:"center"}, 
				   {name:"usMail",index:"usMail",  editable: true,width:80, align:"center"}, 
