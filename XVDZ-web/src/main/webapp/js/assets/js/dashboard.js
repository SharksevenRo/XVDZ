...
var handleInteractiveChart = function () {
	...
	if ($('#interactive-chart').length !== 0) {
        ...
        var xLabel = [
            [1,''],[2,''],[3,'3月15日'],[4,''],[5,''],[6,'3月19日'],[7,''],[8,''],[9,'3月22日'],[10,''],
            [11,''],[12,'3月25日'],[13,''],[14,''],[15,'3月28日'],[16,''],[17,''],[18,'3月31日'],[19,''],[20,'']
        ];
    ...
    $(window).load(function() {
        setTimeout(function() {
            $.gritter.add({
                ...
                image: '../js/assets/img/user-2.jpg',
                sticky: true,
                time: '',
...
var Dashboard = function () {
    ...
    return {
        ...
        init: function () {
            ...
            $.getScript('../js/assets/plugins/gritter/js/jquery.gritter.js').done(function() {
                handleDashboardGritterNotification();
            });
            
            $.getScript('../js/assets/plugins/flot/jquery.flot.min.js').done(function() {
                $.getScript('../js/assets/plugins/flot/jquery.flot.time.min.js').done(function() {
                    $.getScript('../js/assets/plugins/flot/jquery.flot.resize.min.js').done(function() {
                        $.getScript('../js/assets/plugins/flot/jquery.flot.pie.min.js').done(function() {
            ...
            $.getScript('../js/assets/plugins/sparkline/jquery.sparkline.js').done(function() {
                handleDashboardSparkline();
            });
            
            $.getScript('../js/assets/plugins/jquery-jvectormap/jquery-jvectormap-1.2.2.min.js').done(function() {
                $.getScript('../js/assets/plugins/jquery-jvectormap/jquery-jvectormap-world-mill-en.js').done(function() {
                    handleVectorMap();
                });
            });
