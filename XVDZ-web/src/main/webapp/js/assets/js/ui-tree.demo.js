...
var handleJstreeAjax = function() {
    $('#jstree-ajax').jstree({
        "core": {
            ...
            'data': {
                'url': function (node) {
                    return node.id === '#' ? '../js/assets/plugins/jstree/demo/data_root.json': '../js/assets/plugins/jstree/demo/' + node.original.file;
                },
                'data': function (node) {
                    return { 'id': node.id };
                },
...
var TreeView = function () {
    ...
    return {
        //main function
        init: function () {
            $.getScript('../js/assets/plugins/jstree/dist/jstree.min.js').done(function() {
                handleJstreeDefault();
